...
while cap.isOpened():
    ...
    image_filename = "output/image" + str(i) + ".jpg"
    ...
    while torch.no_grad():   #no traing for midas so no grad
        ...
        np.save("output/points" + str(i) + ".npy", output_points)
        np.save("output/colors" + str(i) + ".npy", output_colors)
        ...
        depth_map_filename = "output/depth_map" + str(i) + ".jpg"
