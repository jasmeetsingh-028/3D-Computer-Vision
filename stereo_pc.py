...
cv_file.open('output/stereo/stereoMap.xml', cv2.FileStorage_READ)
...
imgL = cv2.imread('data/stereo_calib_images/stereo Left/1.jpeg')
imgR = cv2.imread('data/stereo_calib_images/stereo Right/1.jpeg')
...
output_file = 'output/stereo/pointCloud.ply'
